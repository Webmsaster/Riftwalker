...
std::vector<WorldTheme> WorldTheme::getAllThemes() {
    return {
        // BALANCE: hazardDensity reduced across all themes (playtest: 85-94% damage from hazards)
        {ThemeID::VictorianClockwork, "Victorian Clockwork",
         ...
         0.35f, 0.15f, 0.05f, 0.4f, false, false},
        ...
        {ThemeID::AncientRuins, "Ancient Ruins",
         ...
         0.3f, 0.15f, 0.06f, 0.5f, false, false},
        ...
        {ThemeID::CrystalCavern, "Crystal Cavern",
         ...
         0.3f, 0.12f, 0.04f, 0.55f, false, false},
        ...
        {ThemeID::BioMechanical, "Bio-Mechanical",
         ...
         0.35f, 0.2f, 0.08f, 0.4f, false, false},
        ...
        {ThemeID::FrozenWasteland, "Frozen Wasteland",
         ...
         0.25f, 0.1f, 0.04f, 0.65f, false, false},
        ...
        {ThemeID::VolcanicCore, "Volcanic Core",
         ...
         0.3f, 0.18f, 0.10f, 0.45f, false, true},
        ...
        {ThemeID::FloatingIslands, "Floating Islands",
         ...
         0.2f, 0.12f, 0.03f, 0.8f, false, false},
        ...
        {ThemeID::VoidRealm, "Void Realm",
         ...
         0.2f, 0.25f, 0.10f, 0.5f, false, false},
