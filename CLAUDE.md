...
- **Music**: 9 OGG tracks (menu_theme, zone1-5, boss_theme, victory, gameover). Zones 4-5 added 2026-05-26 — late-game zones no longer silently reuse zone3. Generator at `tools/gen_zone45_midi.py` + `tools/gen_music_v3.py` (FluidSynth + FluidR3_GM SoundFont).
